...
const productItems: NavItem[] = [
	...
	{ kind: "icon", href: "/products/artificial-intelligence-education-eduai", title: "EduAI", description: "AI-Powered smart and intelligent personal teaching assistant.", icon: SparklesIcon },
	...
	{ kind: "icon", href: "/products/visionx-classroom-management-system", title: "VisionX", description: "Real-time Classroom Monitoring System", icon: EyeIcon },
