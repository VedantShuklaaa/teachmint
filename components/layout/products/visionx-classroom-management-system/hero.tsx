	...
	return (
		<div className="w-full px-3 pt-3 sm:px-4 sm:pt-4">
			<div className="py-10 w-[80%] mx-auto rounded-[30px] border border-white/10 bg-white relative flex flex-col gap-10 overflow-hidden">
				...
				<div className="w-full flex flex-col items-center justify-center gap-2 relative z-10 pt-28 md:pt-30">
					<div className="w-full flex flex-col gap-1 items-center">
						<motion.h1
							...
							VisionX <br /> Classroom Monitoring System
						</motion.h1>
						<motion.p
							initial={{ opacity: 0 }}
							animate={{ opacity: 1 }}
							...
							VisionX delivers real-time classroom visibility and communication in one place, with total privacy. Exclusively on Teachmint X.
						</motion.p>
					</div>
				</div>
				...
				<Video isVideo src="/products/visionX/visionx_intro.mp4" alt="Teachmint - Vission X Hero Video" />
			</div>
		</div>
	)
}