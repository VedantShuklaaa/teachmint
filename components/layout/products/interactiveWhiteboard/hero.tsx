...
const EYEBROW_WORDS = ["CONNECT.", "INTERACT.", "COLLABORATE."];
	...
	return (
		<div className="w-full px-3 pt-3 sm:px-4 sm:pt-4">
			<div className="py-10 w-[80%] mx-auto rounded-[30px] border border-white/10 bg-white relative flex flex-col gap-10 overflow-hidden">
				...
				<div className="flex flex-col items-center justify-center gap-2 relative z-10 pt-28 md:pt-30">
					...
					<div className="flex flex-col gap-1 items-center">
						...
						<motion.p
							...
							Elevate your teaching with our interactive whiteboard, featuring AI-powered tools for a smarter, more engaging and collaborative learning experience.
						</motion.p>
					</div>
				</div>
				...
				<Video isImage src="/products/IWB/whiteboardHero.webp" alt="Teachmint - Interactive Whiteboard Hero Image" />
			</div>
		</div>
	)
}