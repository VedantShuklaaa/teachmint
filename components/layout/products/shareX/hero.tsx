...
import ShareXSpecs from "./shareXSpecs";
			...
			<div className="py-10 w-[80%] mx-auto rounded-[30px] border border-white/10 bg-white relative flex flex-col gap-10 overflow-hidden">
				...
				<div className="w-full flex flex-col items-center justify-center gap-2 relative z-10 pt-28 md:pt-30">
					<div className="w-full flex flex-col gap-1 items-center">
						<div className="relative w-70 h-20 flex items-center">
							<Image
								src="/products/shareX/sharex-iconDark.svg"
								alt="Teachmint - Share X Logo"
								fill
								className=""
							/>
						</div>
						<motion.h1
							...
							Seamless Screen Sharing for Smarter Classrooms
						</motion.h1>
						<motion.p
							initial={{ opacity: 0 }}
							animate={{ opacity: 1 }}
							...
							Connect devices instantly and share content effortlessly for smoother, more interactive teaching.
						</motion.p>
					</div>
				</div>
				...
				<div className="flex flex-col gap-2">
					<Video isImage src="/products/shareX/shareXHero.svg" alt="Teachmint - Share X Hero Image" />
