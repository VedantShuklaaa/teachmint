	...
	return (
		<div className="w-full px-3 pt-3 sm:px-4 sm:pt-4">
			<div className="py-10 w-[80%] mx-auto rounded-[30px] border border-white/10 bg-white relative flex flex-col gap-10 overflow-hidden">
				...
				<div className="flex flex-col items-center justify-center gap-2 relative z-10 pt-28 md:pt-30">
					<div className="flex flex-col gap-1 items-center">
						<motion.h1
							...
							AI-Powered Digital Board for Teaching
						</motion.h1>
						<motion.p
							initial={{ opacity: 0 }}
							animate={{ opacity: 1 }}
							...
							Experience Teachmint X digital board, designed to enhance classroom learning with cutting-edge features tailored for effective teaching.
						</motion.p>
					</div>
				</div>
				...
				<Video isImage src="/solutions/heroImage.png" alt="Teachmint - Digital Board for Teaching Landing Page Hero Image" />
			</div>
		</div>
	)
}